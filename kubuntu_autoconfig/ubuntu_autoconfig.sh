...
echo -e 'This script installs some packages that I consider necessary to use Kubuntu as a daily driver.\n'
...
echo -e 'For more information, please check the help page.\n'
###====================================================================================================================
